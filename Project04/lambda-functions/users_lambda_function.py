...
def lambda_handler(event, context):
  try:
    ...
    if method == "POST":
      ...
      insert_sql= "INSERT INTO users(username, pwdhash) VALUES(%s, %s)"
      
      if result == () :
        hash_password=auth.hash_password(password, salt_rounds=12) 
        datatier.perform_action(dbConn, insert_sql, [username, hash_password])
      else:
